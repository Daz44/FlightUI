...
public class EnginePanelGuage extends JPanel {
	GaugeIndicator guageIndEng1N1 = new GaugeIndicator(10, 10, 50, 50, 0, 100,
			1, true);
	GaugeIndicator guageIndEng1N2 = new GaugeIndicator(530, 10, 50, 50, 0, 100,
			1, true);
	GaugeIndicator guageIndEng2N1 = new GaugeIndicator(10, 70, 50, 50, 0, 100,
			1, true);
	GaugeIndicator guageIndEng2N2 = new GaugeIndicator(530, 70, 50, 50, 0, 100,
			1, true);
	...
	GaugeIndicator guageIndThrot1 = new GaugeIndicator(275, 10, 50, 50, 0,
			16384, 1, true);
	GaugeIndicator guageIndThrot2 = new GaugeIndicator(275, 70, 50, 50, 0,
			16384, 1, true);
